...
Com.prototype.page_loaded = function(cb) {
    ...
    self.dom_red_3 = self.com.get("red_3");
    self.dom_red_4 = self.com.get("red_4");
    self.dom_red_5 = self.com.get("red_5");
...
Com.prototype.get_draw_number = function() {
    ...
    var red_2 = self.dom_red_2.val();
    var red_3 = self.dom_red_3.val();
    var red_4 = self.dom_red_4.val();
    var red_5 = self.dom_red_5.val();

    var blue_1 = self.dom_blue_1.val();
    var blue_2 = self.dom_blue_2.val();

    var number = red_1 + "," + red_2 + "," + red_3 + "," + red_4 + "," + red_5
        + "|" + blue_1 + "," + blue_2;
    return number;
}
