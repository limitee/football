...
impl Helper {
    ...
    pub fn get_count(choice_length:&Vec<i32>, mn:&str) -> i32 {
        ...
        if (m as usize) != choice_length.len() {
            return -1;
        }
...
pub struct ValidateJcl0101;

impl Validate for ValidateJcl0101 {
	...
	fn validate(&self, ticket: &Json, game:&Game, play_type:&PlayType, bet_type:&BetType) -> ValidateResult {
        ...
        if bet_type.id == 1 && number_cc_array.len() > 1 {
		    return Result::Err(ErrCode::NumberIsWrong as i32);
        }
...
pub struct ValidateJcl0102;

impl Validate for ValidateJcl0102 {
	
	fn validate(&self, ticket: &Json, game:&Game, play_type:&PlayType, bet_type:&BetType) -> ValidateResult {
        ValidateJcl0101.validate(ticket, game, play_type, bet_type)
	}
}

pub struct ValidateJcl0201;

impl Validate for ValidateJcl0201 {
...
pub struct ValidateJcl0202;

impl Validate for ValidateJcl0202 {
...
pub struct ValidateJcl0301;

impl Validate for ValidateJcl0301 {
	...
	fn validate(&self, ticket: &Json, game:&Game, play_type:&PlayType, bet_type:&BetType) -> ValidateResult {
        ...
        for number_array in number_cc_array {
            ...
            choice_length.push(select_array.len() as i32);
		    for select in select_array {
			    if HP.sfc_items.contains(select) {
...
pub struct ValidateJcl0302;

impl Validate for ValidateJcl0302 {
	
	fn validate(&self, ticket: &Json, game:&Game, play_type:&PlayType, bet_type:&BetType) -> ValidateResult {
        ValidateJcl0301.validate(ticket, game, play_type, bet_type)
	}
}

pub struct ValidateJcl0401;

impl Validate for ValidateJcl0401 {
...
pub struct ValidateJcl0402;

impl Validate for ValidateJcl0402 {
	
	fn validate(&self, ticket: &Json, game:&Game, play_type:&PlayType, bet_type:&BetType) -> ValidateResult {
        ValidateJcl0401.validate(ticket, game, play_type, bet_type)
	}
}

pub struct ValidateJcl1002;

impl Validate for ValidateJcl1002 {
